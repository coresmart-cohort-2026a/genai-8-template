...
**Path: [one / two].** [Path one: your Module 5 DocuRAG service, on its own
corpus. Path two: the harness's built-in service on the Module 4 Attention
index, with a new seed set of your own. One sentence on why, if two.]

**Service attacked:** [`service/` in this folder / `../project-10-docurag`
in this repository], at commit `[hash]`. [If your Module 5 submission is still
...
`.github/workflows/project-12-ragbench.yml`, [green on this pull request / what
